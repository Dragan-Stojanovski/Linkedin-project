...
const RegisterPage: React.FC = (): JSX.Element => {
   ...
   *
   * @param data - {@link IRegisterFormFields} The data from the registration form.
   * @returns The result of the registration process.
   */
  async function registerUserFn(data: IRegisterFormFields) {
    try {
      let result = await registerNewUser(data);
      setSuccessMsg("Succesfully Registered!");
      setTimeout(() => {
  ...
  return (
    <Fragment>
      ...
      <div className={styles.register_page_wrapper}>
        ...
        {errorMsg && <div className={styles.errors_msg}> {errorMsg} </div>}
        <form
        ...
        >
          <div className={styles.register_page_field}>
            <TextField
              name="email"
              type="text"
              label="Email"
